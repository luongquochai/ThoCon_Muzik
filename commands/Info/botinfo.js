            ...
            cpuStat.usagePercent(function (e, percent, seconds) {
                try {
                    ...
                    const botinfo = new MessageEmbed()
                        ...
                        .setFooter("Coded by: tibbaR#8979", "https://cdn.discordapp.com/attachments/893153516745531410/901047705118326794/thoconcamsung.png?size=512");
                    message.reply({
                        embeds: [botinfo]
                    });
                    ...
                    const botinfo = new MessageEmbed()
                        ...
                        .addField("💻 Platform", `\`\`${os.platform()}\`\``, true)
                        .addField("API Latency", `\`${client.ws.ping}ms\``, true)
                        .setFooter("Coded by: tibbaR#8979", "https://cdn.discordapp.com/avatars/442355791412854784/a_d5591ce201b3018a7aa06c3f77d4b6f0.gif?size=512");
                    message.reply({
                        embeds: [botinfo]
                    });
                }
